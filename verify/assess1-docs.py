...
⚠ 평가요소 이름 4개 · 배점 5·5·5·5 · 기본점수 8점은 계획서 6-가 그대로입니다.
   2026-09-14 선생님과 정한 채점 방식 — **결격 사유 방식**. 평범하게 잘 쓰면 5점, 결격 사유가
   1가지면 4점, 2가지 이상이거나 성의 없는 답안이면 3점, 미작성 2점. 작성 조건은 결격 사유와 짝을 이룹니다.
   문항마다 「작성 안내」(GUIDE)와 「더 쓰면 좋은 것」(MORE — 점수와 관계없음)을 둡니다.
...
ITEMS = [
    ('1', '문제 상황 선정', 5, '①',
     '선정한 문제 상황을 쓰고, 그 문제를 선정한 이유를 서술하시오.',
     ['문제 상황을 접한 경로를 밝힐 것. 기사 · 글 · 영상이면 제목, 매체나 사이트, 날짜를 적을 것',
      '선정한 이유에 자신의 실생활이나 진로(관심 분야)와의 관계를 드러낼 것'],
     [('선정한 이유', 4)]),
    ('2', '문제 상황 분석', 5, '①',
     '선정한 문제 상황이 어떤 상황이고 어떤 어려움이 있는지 자신의 말로 서술하고, 지금의 해결 방식과 비교하여 '
     '이 문제에 인공지능이 필요한 까닭을 서술하시오.',
     ['누가, 어떤 상황에서, 어떤 어려움을 겪는지 밝힐 것',
      '지금은 이 문제를 어떻게 해결하고 있는지와 그 방식의 한계를 들어, 인공지능이 필요한 까닭을 서술할 것'],
     [('문제 상황과 어려움', 3), ('인공지능이 필요한 까닭', 3)]),
    ('3', '인공지능 구상', 5, '②',
     '문제를 해결할 인공지능이 무엇을 하는지 쓰고, 그 동작을 아래 제시된 인공지능의 특성과 연관지어 서술하시오. '
     '(제시어를 모두 활용할 필요는 없음)',
     ['인공지능이 무엇을 입력받아 무엇을 해 주는지 밝힐 것',
      '고른 특성마다 인공지능의 어떤 동작에 해당하는지 쓸 것'], 5),
    ('4', '도입 전후 비교', 5, '③',
     ...
     [('도입 전과 후', 4), ('새로 생길 수 있는 문제', 3)]),
    ('5', '인공지능 시스템의 구조', 5, '④',
     '구상한 인공지능이 환경 및 인간과 주고받는 과정을 아래 제시어의 다섯 단계로 나누어 서술하시오.',
     ['다섯 단계마다 자신의 인공지능에서 무엇에 해당하는지 쓸 것',
      '인공지능이 스스로 판단하는 부분과 그 판단의 내용을 밝힐 것'], 12),
]

# 작성 안내 — 무엇을 어떤 차례로 쓰면 되는지 (내용 예시 · 빈칸 문장 틀은 넣지 않음). 사이트 · 안내서에 싣습니다.
GUIDE = {
    '1': [('경로', '이 문제를 어디서 알게 되었는지 적는다. 기사 · 뉴스는 기사 제목, 매체, 날짜를, 인터넷 글 · 영상은 '
                  '글이나 영상의 제목, 사이트나 채널 이름, 날짜를, 직접 겪거나 들은 일은 언제, 어디서, 누구의 경험인지를 적는다.'),
          ('문제 상황', '어떤 문제인지 한 줄로 쓴다. 자세한 설명은 2번에 쓴다.'),
          ('선정한 이유', '이 문제를 알게 된 계기와, 그것이 자신의 생활이나 진로와 어떻게 이어지는지 쓴다. '
                      '"자료를 찾기 쉬워서"처럼 고른 과정만 쓰면 이유로 인정되지 않는다.')],
    '2': [('문제 상황과 어려움', '기사 문장을 옮기지 말고 자신의 말로 쓴다. 누가(어려움을 겪는 사람이나 기관), '
                           '어떤 상황에서(언제, 어디서, 어떤 일을 할 때), 어떤 어려움을(무엇이 불편하거나 위험하거나 손해인지) '
                           '겪는지 쓴다. 기사에 숫자가 있으면 함께 써도 좋다.'),
          ('인공지능이 필요한 까닭', '지금은 이 문제를 어떻게 해결하고 있는지(사람이 직접 하는지, 정해진 규칙이나 프로그램으로 '
                             '하는지) 쓰고, 그 방식으로는 왜 충분히 해결되지 않는지 쓴 뒤, 그래서 인공지능이 필요하다는 '
                             '결론으로 잇는다. 인공지능이 구체적으로 무엇을 하는지는 3번에 쓴다.')],
    '3': [('하는 일', '이 인공지능이 무엇을 받아들여 무엇을 해 주는지 한두 문장으로 먼저 쓴다. 기존의 것이면 실제로 하는 일을 쓴다.'),
          ('특성', '특성을 하나씩 골라 특성의 이름과 그에 해당하는 동작을 함께 쓴다. 두세 가지면 충분하다. '
                 '고른 특성이 맞는지 위 표의 뜻과 비교해 확인한다.')],
    '4': [('도입 전과 후', '비교할 점을 먼저 밝히고, 그 점에서 도입 전 모습과 도입 후 모습을 차례로 쓴다. 비교할 점은 하나여도 된다. '
                     '도입 전은 인공지능을 쓰지 않는 지금의 모습이다.'),
          ('새로 생길 수 있는 문제', '인공지능은 실수할 수 있는 시스템이다(교과서 23쪽). 인공지능이 잘못 판단하면 누구에게 '
                             '어떤 일이 생기는지, 그래서 사람이 맡아야 할 부분이 무엇인지 쓴다.')],
    '5': [('쓰는 차례', '단계 이름을 앞에 붙여 차례대로 쓴다.'),
          ('환경 · 인간', '인공지능이 어디에서, 누구와 함께 작동하는지'),
          ('인식 (입력)', '무엇을 어떤 방법으로 받아들이는지'),
          ('상황 판단', '받아들인 것으로 무엇을 판단하는지 — 인공지능이 스스로 판단하는 부분이다'),
          ('행동 결정', '판단 결과에 따라 어떤 행동을 고르는지'),
          ('행동 (출력)', '실제로 무엇을 내놓거나 하는지')],
}
# 더 쓰면 좋은 것 — 점수와 관계없음 (빠져도 감점하지 않음)
MORE = {
    '1': '이 문제가 해결되면 누구에게 어떤 도움이 되는지',
    '2': '문제가 해결되었다고 판단할 수 있는 기준',
    '3': '그 동작을 왜 그 특성이라고 볼 수 있는지',
    '4': '비교할 점을 두 가지 이상 드는 것, 도입 후 기대되는 변화',
    '5': '행동한 뒤 환경이 어떻게 바뀌고, 그것이 다시 인식 단계로 이어져 되풀이되는 흐름',
}
...
# 채점 기준 — 실제 채점은 이것으로 (요소, 이름, 해당 문항, [결격 사유…], [(점수, 수준)…])
# 2026-09-14 결격 사유 방식 — 계획서 6-가 수행 수준 문장을 "평범하게 잘 쓰면 5점, 치명적인 결격이 있을 때만 감점" 으로 풀어 씀.
# 결격 사유는 문항의 작성 조건과 짝을 이룹니다.
SCALE = [
    ('①', '문제 상황을 탐색하고 필요한 인공지능 구상하기', '1 · 2번',
     ['문제 상황을 접한 경로를 밝히지 않음',
      ...
      '지금의 해결 방식과 그 한계를 들지 않고 인공지능이 필요한 까닭을 서술하거나, 까닭이 없음'], [
        (5, '인공지능으로 해결할 수 있는 문제 상황을 선정하여 경로, 실생활이나 진로와의 관계, 어려움을 겪는 대상과 어려움, '
            '지금 방식의 한계에 따라 인공지능이 필요한 까닭을 서술함 (결격 사유 없음)'),
        (4, '결격 사유 1가지에 해당함'),
        (3, '결격 사유 2가지 이상에 해당하거나, 성의 없는 답안'),
    ...
    ('②', '인공지능의 특성을 적용하여 설명하기', '3번',
     ['인공지능이 무엇을 하는지 드러나지 않음',
      ...
      '특성을 그 뜻과 맞지 않는 동작에 연결함'], [
        (5, '구상한 인공지능이 하는 일을 밝히고, 그 동작을 인공지능의 특성과 연결하여 서술함 (결격 사유 없음)'),
        (4, '결격 사유 1가지에 해당함'),
        (3, '결격 사유 2가지 이상에 해당하거나, 성의 없는 답안'),
    ...
    ('③', '인공지능 도입 전후를 비교·분석하기', '4번',
     ['도입 전의 모습을 서술하지 않음 (도입 후 좋아지는 점만 씀)',
      '도입에 따라 새로 생길 수 있는 문제를 서술하지 않음'], [
        (5, '인공지능 도입 전과 후를 비교하여 서술하고, 새로 생길 수 있는 문제를 분석함 (결격 사유 없음)'),
        (4, '결격 사유 1가지에 해당함'),
        (3, '결격 사유 2가지에 모두 해당하거나, 성의 없는 답안'),
        (2, '미작성이거나, 도입 전후를 비교하지 못함')]),
    ('④', '인공지능 시스템의 구조로 표현하기', '5번',
     ['다섯 단계 가운데 빠진 단계가 있음',
      '인공지능이 스스로 판단하는 부분이 드러나지 않음'], [
        (5, '다섯 단계를 자신의 인공지능 내용으로 서술하고, 인공지능이 스스로 판단하는 부분을 밝힘 (결격 사유 없음)'),
        (4, '결격 사유 1가지에 해당함'),
        (3, '결격 사유 2가지에 모두 해당하거나, 성의 없는 답안'),
        (2, '미작성이거나, 단계 이름만 나열하여 자신의 인공지능 내용이 드러나지 않음')]),
]
PRINCIPLE = '문항이 요구한 내용을 자신의 문제 상황에 맞게 서술하면 5점이다. 영역별 결격 사유가 있을 때만 점수가 내려간다.'
SLOPPY = ['자신의 문제 상황과 관계없는 일반적인 내용만 씀 (예: "인공지능은 편리하다")',
          '다른 문항의 답을 옮겨 쓰거나, 발문을 되풀이함',
          '내용이 짧아 인공지능이 무엇을 하는지 알 수 없음']
NOPENALTY = ['맞춤법 · 띄어쓰기 · 어색한 문장', '수치가 없는 것', '비교할 점이 하나뿐인 것', '제시어를 모두 쓰지 않은 것',
             '조건을 쓰는 순서', '분량이 짧은 것 (요구한 내용이 들어 있으면 5점)', '「더 쓰면 좋은 것」을 쓰지 않은 것']
MARK = '㉮㉯㉰㉱'
...
def defects_html(df):
    return '<br>'.join('%s %s' % (MARK[i], d) for i, d in enumerate(df))


def scale_table():
    rows = ''
    for no, name, where, df, levels in SCALE:
        for k, (pt, txt) in enumerate(levels):
            first = ('<td class="center" rowspan="4">%s %s<br><span class="small">(%s)</span></td>'
                     '<td rowspan="4">%s</td>' % (no, name, where, defects_html(df))) if k == 0 else ''
            rows += '<tr>%s<td class="center">%d점</td><td>%s</td></tr>' % (first, pt, txt)
    return ('<table class="tight dense"><tr><th style="width:34mm">평가 요소</th><th style="width:60mm">결격 사유</th>'
            '<th style="width:11mm">배점</th><th>채점 기준</th></tr>%s</table>' % rows)


def rules_html():
    li = lambda xs: ''.join('<div class="hint" style="margin:.3mm 0 .3mm 2mm">∙ %s</div>' % x for x in xs)
    return ('<p class="hint" style="margin:1.2mm 0"><b>채점 원칙</b> — %s</p>'
            '<p class="hint" style="margin:1.2mm 0 .3mm"><b>성의 없는 답안</b> — 결격 사유와 관계없이 그 영역 3점</p>%s'
            '<p class="hint" style="margin:1.2mm 0 .3mm"><b>감점하지 않는 것</b> — %s</p>'
            % (PRINCIPLE, li(SLOPPY), ' · '.join(NOPENALTY)))


def guide_items_html():
    out = ''
    for no, title, *_ in ITEMS:
        rows = ''.join('<div class="fl"><span class="fn">%s</span><span>%s</span></div>' % g for g in GUIDE[no])
        more = ('<div class="fl"><span class="fn" style="color:#666">더 쓰면 좋은 것</span>'
                '<span style="color:#444">%s (점수와 관계없음)</span></div>' % MORE[no]) if MORE.get(no) else ''
        out += '<div class="src"><div class="st">%s번 %s</div>%s%s</div>' % (no, title, rows, more)
    return out


def feat_table():
    rows = ''.join('<tr><td class="center" style="width:22mm"><b>%s</b></td><td>%s</td></tr>' % tuple(f) for f in FEATURES)
    return ('<table class="tight" style="margin:0 0 1.6mm"><tr><th>제시어</th><th>뜻 (교과서 16쪽)</th></tr>%s</table>'
            % rows)
...
def sheet():
    ...
    b1 = block(0, mid='<div class="res"><span>문제 상황을 접한 경로</span><span class="rl"></span></div>'
                      '<div class="res"><span>선정한 문제 상황</span><span class="rl"></span></div>')
    b2 = block(1)
    b3 = block(2, note=feat_table(),
...
def guide_scale_table():
    ...
    for no, name, where, df, levels in SCALE:
        ...
        rows += ('<tr><td class="center">%s</td><td>%s</td>%s</tr>'
                 % (head, defects_html(df), ''.join('<td>%s</td>' % txt for pt, txt in levels)))
    return ('<table class="tight dense"><tr><th style="width:20mm">문항</th><th style="width:56mm">결격 사유</th>'
            '<th>5점</th><th style="width:15mm">4점</th><th style="width:21mm">3점</th><th style="width:24mm">2점</th></tr>%s</table>'
            % rows)


def guide():
    body = ('<style>h2{margin:3.4mm 0 1.2mm} table{margin:1.2mm 0} .hint{margin:1mm 0}'
            ' p.small{margin:1mm 0} .src .fl .fn{flex:0 0 34mm}'
...
""" % (FULL, BASE, WHEN, STANDARD[0],
       guide_scale_table(), rules_html(), guide_items_html(),
...
채점은 평가 요소마다 <b>5 · 4 · 3 · 2점 네 수준</b>으로 하되 <b>결격 사유 방식</b>이다 — 결격 사유가 없으면 5점. 계획서의 수행 수준 문장은 뒤에 참고로 실었다.
...
∙ 결격 사유는 문항의 작성 조건과 짝을 이룬다. 답안 어디에 있든 해당 내용이 있으면 서술한 것으로 본다.
...
<h2>계획서 수행 수준 (참고)</h2>
<p class="small">위 채점 기준은 이 문장을 결격 사유 방식으로 풀어 쓴 것이다.</p>
%s
...
<div class="ex">
<p><b>1번. 문제 상황 선정</b> &nbsp;<u>접한 경로</u> 기사 「건강검진 엑스레이 판독 지연, 결절 놓쳐」(○○일보, 2026. 8.).
<u>선정한 문제 상황</u> 흉부 엑스레이 판독이 늦어지고 작은 결절을 놓친다. <u>선정한 이유</u> 나는 영상의학과에
관심이 있고, 지난 건강검진에서 결과가 며칠 뒤에야 나온 일을 겪었다. 건강검진은 누구나 받는 검사라 내 생활과도
이어져 있다 <span class="m">〔① ㉮ · ㉯〕</span>.</p>

<p><b>2번. 문제 상황 분석</b> &nbsp;<u>문제 상황과 어려움</u> 건강검진을 받은 사람이 결과를 기다리는 동안, 영상의학과
의사는 하루에 수백 장의 엑스레이를 판독한다. 피로가 쌓이면 작은 결절을 놓치고 판독이 며칠씩 지연된다
<span class="m">〔① ㉰〕</span>. <u>인공지능이 필요한 까닭</u> 지금은 의사가 엑스레이를 한 장씩 눈으로 판독하고
의심되는 부위가 있으면 추가 촬영을 지시한다. 사람의 눈에 기대는 방식이라 판독량이 늘면 속도와 정확도가 함께
떨어진다. 결절은 크기와 모양, 위치가 일정하지 않아 규칙을 미리 정해 둘 수 없고 많은 영상을 근거로 판단해야 하므로
인공지능이 필요하다 <span class="m">〔① ㉱〕</span>. 한 장을 판독하는 시간이 줄고 놓치는 결절이 줄면 문제가
해결된 것으로 본다.</p>
...
<p><b>4번. 도입 전후 비교</b> &nbsp;<u>도입 전과 후</u> 비교할 점은 한 장당 판독 시간과 놓치는 결절의 수이다. 판독 시간은 도입 전
수 분에서 도입 후 표시된 부위를 중심으로 확인하여 수십 초로 줄고, 놓치는 결절은 도입 전에는 피로도에 따라
늘어나지만 도입 후에는 인공지능이 먼저 표시하므로 줄어든다. 판독이 빨라지고 놓치는
사례가 줄어들 것으로 기대된다. <u>새로 생길 수 있는 문제</u> 갈비뼈와 겹친 작은 결절이나 학습 데이터에 적었던
...
""" % (FEAT_NAMES, AREA, WHEN, FULL, BASE, BASE_ABSENT, ESSAY, STANDARD[0], STANDARD[1],
       scale_table(), rules_html(), plan_rubric,
...
#   2026-09-14 칸을 나눔 — 1번 셋(경로 · 문제 상황 한 줄 · 선정 이유), 2번 둘, 4번 둘. 옛 칸 id 는 그대로 두고 새 칸만 더함.
APP_FIELDS = {
    '1': [dict(id='q1src', label='문제 상황을 접한 경로', type='text'),
          dict(id='q1title', label='선정한 문제 상황 (한 줄)', type='text'),
          dict(id='q1', label='선정한 이유', type='area', rows=6)],
    '2': [dict(id='q2', label='문제 상황과 어려움', type='area', rows=6),
          dict(id='q2why', label='인공지능이 필요한 까닭', type='area', rows=6)],
    ...
    '4': [dict(id='q4', label='도입 전과 후', type='area', rows=6),
          dict(id='q4risk', label='새로 생길 수 있는 문제', type='area', rows=5)],
...
def app_data():
    ...
    for no, title, pt, elem, ask, conds, lines in ITEMS:
        ...
        items.append(dict(no=no, title=title, pt=pt, showPt=(no != '1'), ask=_plain(ask),
                          ...
                          ref=[list(f) for f in FEATURES] if no == '3' else [],
                          guide=[list(g) for g in GUIDE[no]], more=MORE.get(no, '')))
    ...
    return dict(title=AREA, topic=topic, total=FULL, base=BASE,
                ...
                principle=PRINCIPLE, sloppy=SLOPPY, nopenalty=NOPENALTY,
                scale=[dict(no=no, name=name, where=where, defects=df, levels=[[pt, txt] for pt, txt in lv])
                       for no, name, where, df, lv in SCALE])
